...
The most difficult part of this project was understanding how to automate this process. I remember learning how to do this in RMarkdown in lecture by setting parameters and using the `apply` and `render` functions. I was not sure how to apply this to GitHub. My partner helped me by showing me how to not "hard-code" everything so that the automation could work. 
